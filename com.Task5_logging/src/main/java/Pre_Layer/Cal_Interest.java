...
public class Cal_Interest implements Presented1{
	private static final Logger LOGGER=LogManager.getLogger(Cal_Interest.class);
	public static void main(String[] args) {
		Cal_Interest object=new Cal_Interest();
